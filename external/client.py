...
class ExternalClient:
    ...
    def get_product_info(
        self, barcode: str, *, request_options: typing.Optional[RequestOptions] = None
        ...
        client.external.get_product_info(
            barcode="barcode",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"external/lookup-product/{jsonable_encoder(barcode)}",
            method="GET",
...
class AsyncExternalClient:
    ...
    async def get_product_info(
        ...
        async def main() -> None:
            await client.external.get_product_info(
                barcode="barcode",
            )
